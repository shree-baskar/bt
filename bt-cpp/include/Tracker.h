...
private:
    ...
    void loadData();
    void saveData();
    void addTransaction(double amount, std::string& description, Category category, std::chrono::system_clock::time_point& date, Type type);
...
public:
    Tracker();
    void addIncome(double amount, std::string& description, Category category, std::chrono::system_clock::time_point& date);
    void addExpense(double amount, std::string& description, Category category, std::chrono::system_clock::time_point& date);
...
const std::string Tracker::DATA = "transactions.dat";
